return {
  {
    ...
    config = function()
      ...
      dap.adapters.php = {
        ...
        command = 'node',
        args = { os.getenv('HOME') ..
        '/nobackup/vscode-php-debug/out/phpDebug.js' }
      }
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>xb', function() require("dap").toggle_breakpoint() end,
      ...
      vim.keymap.set('n', '<leader>xl', function() require("dapui").float_element "breakpoints" end,
      ...
      vim.keymap.set('n', '<leader>xO', function() require("dap").step_out() end, { desc = "Step Out" })
